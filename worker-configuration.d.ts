/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9378db25e270ffd9a23b70a67e81c8d1)
...
declare namespace Cloudflare {
	...
	interface Env {
		CACHE: KVNamespace;
		OIDC_ISSUER: string;
		AUTH0_INTRANET_CLIENT_ID: string;
		AUTH0_INTRANET_CLIENT_SECRET: string;
		AUTH_INTRANET_API_AUDIENCE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OIDC_ISSUER" | "AUTH0_INTRANET_CLIENT_ID" | "AUTH0_INTRANET_CLIENT_SECRET" | "AUTH_INTRANET_API_AUDIENCE">> {}
}
